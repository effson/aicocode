...
PROJECT_AGENTS_DIR = ".aicocode/agents"
USER_AGENTS_DIR = "~/.aicocode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("aicocode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from aicocode.agents.parser import parse_frontmatter, _validate_agent_meta
                ...
                agent_def = AgentDef(
                    ...
                    max_turns=meta.get("maxTurns") or 200,
