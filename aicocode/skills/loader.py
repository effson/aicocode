...
from aicocode.skills.parser import SkillDef, SkillParseError, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".aicocode/skills"
USER_SKILLS_DIR = "~/.aicocode/skills"


class SkillLoader:
    def __init__(self, work_dir: str) -> None:
        self._work_dir = work_dir   # C:/Users/Mechrev/Desktop/Aico-Code
        self._project_dir = Path(work_dir) / PROJECT_SKILLS_DIR # C:/Users/Mechrev/Desktop/Aico-Code/.aicocode/skills
