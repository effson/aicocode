...
from aicocode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from aicocode.agent import Agent
    from aicocode.agent_event import AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from aicocode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
