...
from aicocode.conversation import Conversation, Message, ToolResultBlock, ToolUseBlock

SESSIONS_DIR = ".aicocode/sessions"

DEFAULT_MAX_AGE_DAYS = 30 # 最大过期时间
TITLE_MAX_LENGTH = 50
...
async def generate_session_summary(
    client: Any, conversation: Conversation, protocol: str
) -> str:
    ...
    summary_conv.messages = [Message(role="user", content=SESSION_SUMMARY_PROMPT)]
    for msg in recent:
